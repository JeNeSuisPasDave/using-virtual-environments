...
$redisExpectedVsn_ = "2.6" -as [System.Version]
$redisMaxVsn_ = "2.7" -as [System.Version]
$flaskExpectedVsn_ = "0.8" -as [System.Version]
$flaskMaxVsn_ = "0.9" -as [System.Version]
$jinja2ExpectedVsn_ = "2.4" -as [System.Version]
$jinja2MaxVsn_ = "2.5" -as [System.Version]
$werkzeugExpectedVsn_ = "0.6" -as [System.Version]
$werkzeugMaxVsn_ = "0.7" -as [System.Version]
...
-or (-not (Test-Version $markupsafeVsn_ -IsLessThan $markupsafeMaxVsn_))) {
  Write-Output ""
  Write-Output "ERROR: Expecting MarkupSafe $markupsafeExpectedVsn_ or later, "
    "up to $markupsafeMaxVsn_."
